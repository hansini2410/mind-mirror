      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pt-32 sm:pt-36 md:pt-40 pb-20">
        ...
        {loading ? (
          ...
          <div className="bg-white/10 border border-white/10 backdrop-blur-xl rounded-[32px] p-6 sm:p-10">
            ...
            <p className="text-slate-300 text-lg sm:text-xl leading-8 sm:leading-9">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {blogs.map((blog, index) => (
              <motion.div
                ...
                className="bg-white/10 border border-white/10 backdrop-blur-xl rounded-3xl p-6 sm:p-8 shadow-2xl"
              >
                ...
                <p className="text-cyan-300 text-xs sm:text-sm uppercase tracking-widest mb-4">
                  {blog.category}
                </p>
